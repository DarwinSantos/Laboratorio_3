package patitas.pe.com.veteriapp.adapters;
...
public class PestAdapter
        extends RecyclerView.Adapter<PestAdapter.PetsViewHolder> {
    ...
    public PestAdapter(List<Pet> pets) {
        this.pets = pets;
    }
